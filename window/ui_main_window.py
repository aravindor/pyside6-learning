...
################################################################################
## Form generated from reading UI file 'main_widows.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/images/cutIcon.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/images/pasteIcon.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionPaste.setIcon(icon2)
        self.actionQuit = QAction(MainWindow)
        self.actionQuit.setObjectName(u"actionQuit")
        icon3 = QIcon()
        icon3.addFile(u":/images/quitIcon.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.menubar.setGeometry(QRect(0, 0, 794, 30))
